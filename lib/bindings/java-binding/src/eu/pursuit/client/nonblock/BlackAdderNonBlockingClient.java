...
public class BlackAdderNonBlockingClient {

	public static final byte[] EMPTY_ARRAY = new byte[0];
	private static BlackAdderNonBlockingClient instance = new BlackAdderNonBlockingClient();
	
	private final BlackadderNonBlockWrapper baWrapper;
	private boolean closed = false;
	
	Semaphore shutDownSemaphore = new Semaphore(1); 
	
	public static BlackAdderNonBlockingClient getInstance() {
		return instance;
	}

	private BlackAdderNonBlockingClient() {
		baWrapper = BlackadderNonBlockWrapper.getWrapper();		
	}
	...
	public void setEventHandler(EventHandler handler){
		baWrapper.setEventHandler(handler);
	}
	
	public void resetEventHandler(){
		baWrapper.resetHandler();
	}
