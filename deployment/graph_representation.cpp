...
//
//GraphRepresentation::GraphRepresentation (network *_dm)
//{
//  dm = _dm;
//}
//
//void
//GraphRepresentation::buildIGraphTopology ()
//{
...
//      network_connection *nc = nn->connections.back ();
...
//    igraph_cattribute_VAS_set (&igraph, "iLID", vertex_index, nn->internal_lid.to_string ().c_str ());
//
//  }
//}
//
...
//
//string
//GraphRepresentation::produceStringLabelsFromIds (int id)
//{
//
//  string reply;
//  stringstream ss;
...
//
//void
//GraphRepresentation::addGeneratedMappedConnection (network_node *nn1, network_node *nn2)
//{
//
//  network_connection *nc = new network_connection ();
//
...
//
//void
//GraphRepresentation::chooseBestTMRVNode (void)
//{
//
...
//    }
//  }
//  network_node * nn = dm->network_nodes[cur_vid];
//  nn->is_rv = true;
//  nn->is_tm = true;
//  dm->RV_node = nn;
//  dm->TM_node = nn;
...
//
//void
//GraphRepresentation::outputLeafVertices (string filename)
//{
//  int degree;
//  ofstream degreeonefile;
//  network_node *nn = NULL;
//
...
//
//void
//GraphRepresentation::buildInputMap ()
//{
//
//  int i, numofvertices;
//  string labelid;
//  igraph_vector_t edge_vector;
//  network_node * nn1 = NULL;
//  network_node * nn2 = NULL;
//
