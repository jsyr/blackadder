...
int main(int argc, char* argv[]) {
    string alg_id, id, prefix_id, bin_alg_id, bin_id, bin_prefix_id;
    ...
    alg_id = "AA00000000000000";
    bin_alg_id = hex_to_chararray(alg_id);
    ba->subscribe_scope(bin_alg_id, bin_prefix_id, IMPLICIT_RENDEZVOUS_ALGID_DOMAIN, NULL, 0);
    id = "0000000000000000";
