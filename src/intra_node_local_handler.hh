...
#ifndef CLICK_INTRANODELOCALHANDLER_HH
#define CLICK_INTRANODELOCALHANDLER_HH
...
class IntraNodeLocalHandler : public LocalHandlerInterface {
public:
    IntraNodeLocalHandler(Dispatcher *_dispatcher_element);
    ~IntraNodeLocalHandler();
