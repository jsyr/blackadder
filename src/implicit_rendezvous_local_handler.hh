...
#ifndef CLICK_IMPLICITRENDEZVOUSLOCALHANDLER_HH
#define CLICK_IMPLICITRENDEZVOUSLOCALHANDLER_HH
...
class ImplicitRendezvousLocalHandler : public LocalHandlerInterface {
public:
    ImplicitRendezvousLocalHandler(Dispatcher *_dispatcher_element);
    ~ImplicitRendezvousLocalHandler();
